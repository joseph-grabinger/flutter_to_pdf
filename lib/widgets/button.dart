...
import 'package:pdf/widgets.dart' as pw show FlatButton, Widget, BoxDecoration, Border, BoxShape;
...
extension ButtonConverter on TextButton {
  pw.FlatButton toPdfWidget(pw.Widget child) => pw.FlatButton(
    ...
    decoration: pw.BoxDecoration(
      border: style?.side?.resolve({}) != null
          ...
          : null,
      color: style?.backgroundColor?.resolve({})?.toPdfColor() ?? const PdfColor(0.2, 0.4, 0.4, 0.1).flatten(background: PdfColors.white),
