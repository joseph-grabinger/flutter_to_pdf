...
class EditOfferDialog extends StatelessWidget {
  ...
  EditOfferDialog(this.offer, {Key? key}) : super(key: key);

  final dateFormat = DateFormat('dd.MM.yyyy');

  late final editID = TextEditingController(text: offer.id.value);
  late final editDate = TextEditingController(text: dateFormat.format(offer.date.value));
  late final editPaymentTime = TextEditingController(text: offer.paymentTime.value.toString());
  late final editOrderNumber = TextEditingController(text: offer.orderNumber.value);
  late final editTaxRate = TextEditingController(text: offer.taxRate.value.toString());

  late final RxList<List<TextEditingController>> editItems = offer.items.map((item) => [
  ...
  late final editHintText = TextEditingController(text: offer.hintText.value);
  late final editRegards = TextEditingController(text: offer.regards.value);
  late final editAdditionalText = TextEditingController(text: offer.additionalText.value);
  ...
  void save(BuildContext context) {
    offer.id.value = editID.text;
    offer.date.value = dateFormat.parse(editDate.text);
    offer.paymentTime.value = int.parse(editPaymentTime.text);
    offer.orderNumber.value = editOrderNumber.text;

    offer.items.value = editItems.map((editItem) => OfferItem(
    ...
    offer.taxRate.value = int.parse(editTaxRate.text);
    offer.hintText.value = editHintText.text;
    offer.regards.value = editRegards.text;
    offer.additionalText.value = editAdditionalText.text;
