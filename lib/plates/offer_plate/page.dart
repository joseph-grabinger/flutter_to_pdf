...
import 'parameters/offer/edit_dialog.dart';
import 'parameters/own_profile/edit_dialog.dart';

const offerAspectRatio = 1 / 1.414;
          ...
          child: Row(
            children: [
                  ...
                  await showDialog(
                    ...
                    builder: (context) => ExportDialog(
                      controller: Get.put(ExportDialogController(
                        ...
                        title: 'Rechnung-${controller.offer.id}'
                      )),
                    ),
                  );
                }
              ...
              OwnIconButton(
                ...
                size: 60.0,
                onTap: () => Get.dialog(EditOfferDialog(controller.offer)),
              ),
              const SizedBox(width: 20.0),
              OwnIconButton(
                icon: Icons.badge,
                          ...
                          children: [
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 1.0),
                                          Obx(() => Text(
                                            DateFormat('dd.MM.yyyy').format(controller.offer.date.value),
                                            style: const TextStyle(
                                              fontSize: 7,
                                              fontWeight: FontWeight.w500,
                                            ),
                                    ...
                                    Expanded(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          const SizedBox(height: 1.0),
                                          Obx(() => Text(
                                            DateFormat('dd.MM.yyyy').format(controller.offer.date.value.add(Duration(days: controller.offer.paymentTime.value))),
                                            style: const TextStyle(
                                              fontSize: 7,
                                              fontWeight: FontWeight.w500,
                                            ),
                                    ...
                                    Expanded(
                                      flex: 1,
                                      child: Obx(() =>controller.offer.orderNumber.isEmpty ? const SizedBox()
                                      : Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            const Text(
                                            ...
                                            const SizedBox(height: 1.0),
                                            Text(
                                              controller.offer.orderNumber.value,
                                              style: const TextStyle(
                                                fontSize: 7,
                                                fontWeight: FontWeight.w500,
                                              ),
                            ...
                            Column(
                              children: [
                                ...
                                Obx(() => Column(
                                  children: controller.offer.items.map((item) {
                                    return Padding(
                              ...
                              children: [
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Obx(() => Text(
                                        controller.offer.hintText
                                          .replaceAll('{{dueDate}}', DateFormat('dd.MM.yyyy').format(controller.offer.date.value.add(Duration(days: controller.offer.paymentTime.value))))
                                          .replaceAll('{{id}}', controller.offer.id.value),
                                        style: const TextStyle(
                                          fontSize: 5,
                                      ...
                                      Obx(() => Text(
                                        controller.offer.regards.value,
                                        style: const TextStyle(
                                          fontSize: 5,
                                          fontWeight: FontWeight.w400,
                                        )
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Obx(() => smText('+ ${controller.offer.taxRate}% MwSt.')),
                                      const SizedBox(height: 2),
                                ...
                                Expanded(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      const Divider(height: 6.0, color: Color(0xffaaaaaa),),
                                      const SizedBox(height: 2),
                                      Obx(() => smText(toMoneyString(controller.offer.totalPrice()))),
                                      const SizedBox(height: 3),
                                      Obx(() => smText('${(controller.offer.taxAmount()/100).toStringAsFixed(2).replaceAll('.',',')} €')),
                                      const SizedBox(height: 2),
                                      const Divider(height: 6.0, color: Color(0xff444444),),
                                      Obx(() => smText('${(controller.offer.totalPrice() * (1+controller.offer.taxRate/100) / 100).toStringAsFixed(2).replaceAll('.',',')} €')),
                                      const Divider(height: 6.0, color: Color(0xff444444),),
                                    ],
                                  ),
                                ),
                            ...
                            Obx(() {
                              if (controller.offer.additionalText.value.isNotEmpty) {
                                return Text(
                                  controller.offer.additionalText.value,
                                  style: const TextStyle(
                                    fontSize: 6,
                                    fontWeight: FontWeight.w400,
                                  )
